...
def run_cluster_permutation_comparison(df, group_a, group_b, label, group_col, save_prefix):
    ...
    ax.tick_params(axis='both', labelsize=20)
    plt.tight_layout()
    img_path = f"rh.gausscurv_cluster_perm_{save_prefix}.png"
...
# === Run comparisons ===
significance_mask = run_cluster_permutation_comparison(df, 1, 0, "(PART vs Control)", "group_PART_vs_control", "PART_vs_Control")
M1 = run_cluster_permutation_comparison(df, 0, 1, "(TDP- vs TDP+)", "tdp_status", "TDPneg_vs_TDPpos")
M2 = run_cluster_permutation_comparison(df, 0, 2, "(TDP- vs Control)", "tdp_status", "TDPneg_vs_Control")
M3 = run_cluster_permutation_comparison(df, 1, 2, "(TDP+ vs Control)", "tdp_status", "TDPpos_vs_Control")
